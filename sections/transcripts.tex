\section{Histone transcripts}
  ...
  \begin{figure}
    ...
    \caption{%
      Sequence logos for
      \protect\subref{fig:stem-loop-seqlogo} annotated stem-loops and
      \protect\subref{fig:HDE-seqlogo}  Histone Downstream Elements (HDEs)
  ...
  signals (\supref{sup:curation-anomalies}).
