  ...
  \label{sup:difference-from-Marzluff02}
  ...
  \captionof{supplement}{%
    ...
    \protect\printdate{\SequencesDate{}}.
  }
  \label{sup:histone-catalogue}
  ...
  \begin{center}
    \captionof{supplement}{
        ...
        listed in table \supref{sup:histone-catalogue}.
        Initiator codon ATG and stop codon are omitted.
    }
    \label{sup:h2a-histone-gene-variation}
  ...
  \begin{center}
    ...
    \label{sup:h2b-histone-gene-variation}
  ...
  \begin{center}
    ...
    \label{sup:h3-histone-gene-variation}
  ...
  \begin{center}
    ...
    \label{sup:h4-histone-gene-variation}
  ...
  \begin{center}
    ...
    \label{sup:histone-gene-differences}
  ...
  \label{sup:histone-gene-codonusage}
  ...
  \captionof{supplement}{
    ...
    Data obtained from NCBI RefSeq \citep{OLearyRefseq2016}
    on \protect\printdate{\SequencesDate{}}.
  }
  \label{sup:curation-anomalies}
  \begin{itemize}
