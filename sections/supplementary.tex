\section*{Supplementary Data}
  ...
  \begin{supplement}
    \caption{
        ...
        annotated in NCBI RefSeq obtained on \printdate{\SequencesDate{}
  ...
  \captionof{supplement}{%
    Catalogue of annotated human canonical core histone genes, transcripts and encoded proteins.
    Data obtained from NCBI RefSeq \citep{OLearyRefseq2016} on \printdate{\SequencesDate{}}.
  }
  ...
  \begin{supplement}
    \caption{
        Synonymous and non-synonymous differences between canonical core histone genes.
        Mean of positional non-synonymous ($d_N$) and synonymous ($d_S$) nucleotide substitution rates 
        and mean of $d_N/d_S$ ratios
        for all pairwise comparisons of canonical core histone gene coding regions
        computed using \citet{GoldmanYang1994} method by PAML \texttt{codeml}.
    }
