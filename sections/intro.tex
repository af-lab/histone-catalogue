...
\end{table*}
	...
	reflecting biochemical, functional and genomic distinctions (\tref{tab:histone-divisions}).
...
\end{table*}
	...
	and has accumulated \todo{TotalNumberDiiferences} differences
	as rich annotations continue to propagate into reference sequence databases (\tref{tab:difference-from-Marzluff02}).
