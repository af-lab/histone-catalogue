\section{Introduction}
  ...
  \afterpage{
    ...
    \begin{shaded}
      \begin{description}
        ...
        \item[Oncohistones] \hfill \newline
        Histone genes with missense mutations occuring at high frequency in certain cancers.
  ...
  \subsection{Functional perspective}
    ...
    for DNA duplicated during replication \citep{WuBonner1981,MendirattaAlmouzni2019}.
  ...
  \subsection{Genomic perspective}
    ...
    A number of mutations in individual canonical and variant histone genes
    have been revealed to contribute to cancer \citep{WeinbergAllis2017,FunatoTabar2018}.
    These ``oncohistones'' demonstrate that single amino acid changes
    in individual histone genes can have functional implications.
  ...
  \subsection{Cataloguing of canonical core histone diversity}
    ...
    histone sequences and derived analysis from across eukarya using sequence homology searching
    ...
    \citep{Ederveen2011,HIstome2012,OLearyRefseq2016,ElkennaniGovin2017,ShahGupta2020}.
    ...
    but whose functional implications have not been investigated \citep{SinghParthun2018}.
    ...
    The manuscript generation process has functioned in our laboratory since 2013
    and represents an example of ``reproducible research'' \citep{Claerbout2000} that
    provides a novel model for ``biocuration'' \citep{biocuration2018}
    and cataloguing of gene families.
