\section{Introduction}
  ...
  %% Get tables out of the first page.  After we made the abstract
  %% shorter to follow eLife requirements, this gets moved to the
  %% first page and above the title.
  \afterpage{
  \begin{table}
  ...
  and summarised in \bref{tab:histone-divisions}.
  ...
  \subsection{Cataloguing of canonical core histone diversity}
    ...
    (\supref{sup:difference-from-Marzluff02})
