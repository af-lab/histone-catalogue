\section{Reproducible research}
  ...
  being updated for the current RefSeq release (\supref{sup:difference-from-Marzluff02}).
  ...
  \supref{sup:curation-anomalies} lists the current apparent anomalies from these tests
