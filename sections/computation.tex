\section{Reproducible research}
  ...
  sequences updated (\supref{sup:difference-from-Marzluff02}).
  ...
  to ongoing curation of genomics resources
  and to feed back information to database maintainers \citep{SteinNRG2001},
  although many are unaware of this opportunity \citep{HollidaySPR2015}.
  We have submitted a significant number of proposals
  ...
  \supref{sup:curation-anomalies} lists current apparent anomalies from these tests
  ...
  They can also become moribund or inaccessible.
