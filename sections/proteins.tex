\section{Histone proteins}
  ...
  all suggest that the minor differences in canonical core histone protein isoforms
  ...
  \subsection{Canonical H2A isoforms}
    ...
    and the C-terminal residues from residue 124 onwards (\tref{tab:H2A-consensus}).
  ...
  \subsection{Canonical H2B isoforms}
    Canonical H2B has the most isoforms of the 4 core histone types (\tref{tab:H2B-consensus})
