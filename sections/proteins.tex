\section{Histone proteins}
  ...
  \subsection{Canonical H2A isoforms}
    ...
    \begin{TableAndFigure*}
      ...
      \captionof{figure}{Canonical H2A protein isoforms.
                         Upper panel shows isoforms relative to the most common protein sequence.
                         Lower panel shows sequence logo of all isoforms aligned with invariant residues in grey.}
    \end{TableAndFigure*}
  ...
  \subsection{Canonical H2B isoforms}
    ...
    followed by a very variable residue with either alanine, serine, threonine or valine \fref{fig:H2B-weblogo}.
    ...
    \begin{TableAndFigure*}
      ...
      \captionof{figure}{Canonical H2B protein isoforms.
                         Upper panel shows isoforms relative to the most common protein sequence.
                         Lower panel shows sequence logo of all isoforms aligned with invariant residues in grey.}
    \end{TableAndFigure*}

  \subsection{Canonical H3 isoforms}
    Canonical H3 genes encode only \HThreeUniqueProteins{} different canonical isoforms \fref{tab:H3-consensus}.
    ...
    As discussed in \Sref{sec:hist3h3}, \textit{HIST3H3} appears to be a largely testes specific variant H3T
    ...
    \begin{TableAndFigure*}
      ...
      \captionof{figure}{Canonical H3 protein isoforms.
                         Upper panel shows isoforms relative to the most common protein sequence.
                         Lower panel shows sequence logo of all isoforms aligned with invariant residues in grey.}
    \end{TableAndFigure*}
  ...
  \subsection{Canonical H4 isoforms}
    ...
    \begin{TableAndFigure*}
      ...
      \captionof{figure}{Canonical H4 protein isoforms.
                         Upper panel shows isoforms relative to the most common protein sequence.
                         Lower panel shows sequence logo of all isoforms aligned with invariant residues in grey.}
    \end{TableAndFigure*}
