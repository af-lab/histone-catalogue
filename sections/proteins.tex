\section{Histone proteins}
  ...
  could have functional implications \citep{SinghParthun2018,ArimuraKurumizaka2018}.
  ...
  coding genes repectively (\tref{tab:histone-gene-count}).
...
%% To include methionine just uncomment 3 lines in the routine that reads the sequence files in MyLib.pm
  ...
  \subsection{Canonical H2B isoforms}
    ...
    diverging down to \FPround{\result}{\HTwoBPID}{0}\result\% pairwise identity.
    ...
    \begin{table}
      \caption{%
        ...
        are shown separately and distingushed by a numerical suffix (see \tref{tab:histone-catalogue}).
        Lower panel shows sequence logo of all isoforms aligned
        with invariant residues in grey.
      }
