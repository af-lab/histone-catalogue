...
\subsection{Canonical histone gene nomenclature}
    ...
    \begin{figure*}[hp]
	  ...
	  \todo[inline]{Include part using HIST1H2APS2 as example of PS pseudogene nomenclature}
	  ...
	  \todo[inline]{Change part C to use H2AFY2 as a more complete example of variant nomenclature}
