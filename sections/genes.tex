\section{Histone genes}
  ...
  \subsection{Canonical core histone gene nomenclature}
    ...
    the same cluster (\fref{subfig:nomenclature-coding-canonical}).
    ...
    \begin{figure*}
      \centering
      \subfloat[canonical coding gene]{%
        \begin{minipage}{0.37\textwidth}
          \centering
          \Huge{%
            \colorbox{red!60}{\strut \textit{HIST1}}%
            \colorbox{green!60}{\strut \textit{H2B}}%
            \colorbox{blue!40}{\strut \textit{D}}%
          }

          \scriptsize{%
            \colorbox{blue!40}{\strut 4\textsuperscript{th}}%
            \colorbox{green!60}{\strut H2B}%
            \colorbox{red!60}{\strut in Histone cluster 1}
          }
        \end{minipage}
        \label{subfig:nomenclature-coding-canonical}
      }%
      \subfloat[canonical pseudogene]{%
        \begin{minipage}{0.37\textwidth}
          \centering
          \Huge{%
            \colorbox{red!60}{\strut \textit{HIST2}}%
            \colorbox{green!60}{\strut \textit{H3}}%
            \colorbox{yellow!60}{\strut \textit{PS}}%
            \colorbox{blue!40}{\strut \textit{2}}%
          }

          \scriptsize{%
            \colorbox{blue!40}{\strut 2\textsuperscript{nd}}%
            \colorbox{green!60}{\strut H3}%
            \colorbox{yellow!60}{\strut pseudogene}%
            \colorbox{blue!40}{\strut found}%
            \colorbox{red!60}{\strut in cluster 2}
          }
        \end{minipage}
      ...
      \subfloat[variant]{%
        \begin{minipage}{0.22\textwidth}
          \centering
          \Huge{%
            \colorbox{red!60}{\strut \textit{H2A}}%
            \colorbox{green!60}{\strut \textit{F}}%
            \colorbox{blue!40}{\strut \textit{X}}%
          }

          \scriptsize{%
            \colorbox{red!60}{\strut H2A }%
            \colorbox{green!60}{\strut Family }%
      ...
      \caption{Histone gene nomenclature.
               \protect\subref{subfig:nomenclature-coding-canonical}
               Canonical core histone gene names encode relative genomic
               order by cluster.
               \protect\subref{subfig:nomenclature-pseudo-canonical}
               Pseudogenes named since 2002 include cluster, PS label,
               and discovery order identifier.
               \protect\subref{subfig:nomenclature-variant}
    ...
    naming (\supref{sup:difference-from-Marzluff02})
  ...
  \subsection{Histone gene sequences}
    ...
    (\supref{sup:h2a-histone-gene-variation},~\supref{sup:h2b-histone-gene-variation},
    ~\supref{sup:h3-histone-gene-variation}, and~\supref{sup:h4-histone-gene-variation}).
    ...
    and \FPround{\result}{\MeanHFourdS}{1} \result{} for H4 (\supref{sup:histone-gene-differences}).
    ...
    (\supref{sup:histone-gene-codonusage} and data not shown).
  ...
  \subsection{Histone variant genes}
    ...
    are listed in \supref{sup:variant-catalogue} for completeness.
    ...
    and an identifier letter (\fref{subfig:nomenclature-variant}).
