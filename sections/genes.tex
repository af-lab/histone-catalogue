\section{Histone genes}
  ...
  \subsection{Histone gene clusters}
	...
	The implications of tight and exclusive histone gene clustering is not well understood \addref{Eirin-Lopez EvBiolCh8 2009}. 
	This organisation has been suggested to imply that expression is regulated by local elements \citep{close-regulators}, 
	whereas a role in histone gene sequence conservation is disputed \addref{NeiRooneyARG2005}. 
  ...
  \subsection{Histone gene sequences}
	...
	synonymous codon divergence exceeds non-synonymous variation across eukaryotes \addref{Piontkivska MolBiolEvol 2000} \addref{Rooney MolBiolEvol 2002}. 
    ...
    \begin{figure*}
	  ...
	  \todo[inline]{Parts A and B need labels. Name text need to be italics!}
