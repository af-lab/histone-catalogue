\section{Histone genes}
    ...
    \begin{figure*}
      ...
      \subbottom[canonical coding gene]{%
        \begin{minipage}{0.37\textwidth}
          \centering
          \Huge{%
            \colorbox{red}{\strut \textit{HIST1}}%
            \colorbox{green}{\strut \textit{H2B}}%
      ...
      \subbottom[canonical pseudogene]{%
        \begin{minipage}{0.37\textwidth}
          \centering
          \Huge{%
            \colorbox{red}{\strut \textit{HIST2}}%
            \colorbox{green}{\strut \textit{H3}}%
            \colorbox{yellow}{\strut \textit{PS}}%
      ...
      \subbottom[variant]{%
        \begin{minipage}{0.22\textwidth}
          \centering
          \Huge{%
            \colorbox{red}{\strut \textit{H2A}}%
            \colorbox{green}{\strut \textit{F}}%
  ...
  \subsection{Histone gene sequences}
    ...
    (\tref{fig:h2a-histone-gene-variation},~\ref{fig:h2b-histone-gene-variation},
    ...
    and \FPround{\result}{\MeanHFourdS}{1} \result{} for H4 (\tref{tab:histone-gene-differences}).
