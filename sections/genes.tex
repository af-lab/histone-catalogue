\section{Histone genes}
  ...
  \subsection{Histone gene clustering}
    ...
    Progress in understanding histone gene function may lead to changes in these cluster properties.
    ...
    and is located \SI{300}{\kilo\bp} upstream of the rest of the HIST1 cluster
    ...
    \label{sec:hist3h3}
    Similarly, the small HIST3 cluster \SI{80}{\mega\bp} downstream of HIST2
    contains protein coding genes \textit{HIST3H2A}, \textit{HIST3H2BB},
    and \textit{HIST3H3}.
    ...
    if the space between \textit{HIST1H2AA} and the rest of HIST1 is excluded.
  ...
  \subsection{Histone gene sequences}
    ...
    between sets of canonical histone genes is
