\section{Histone genes}
  ...
  \subsection{Histone gene clusters}
    ...
    %% Did no one ever used the DNA sequence for each of the histones
    %% and got a tree about which evolved from which, since we got the
    %% genome sequenced?
    %% Also, this birth-and-death model has a lot of papers but almost all of them
    %% have Masatoshi Nei as one of the authors and his examples on usage of
    %% the model are papers where he's also an author.
