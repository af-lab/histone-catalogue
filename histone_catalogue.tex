...
\begin{document}
  ...
  \section{Acknowledgements}
    We are grateful to the community on \url{irc.freenode.net} channels \#perl and \#bioperl,
    especially Altreus, mst, LeoNerd, and pyrimidine.
    Invaluable support was provided by the \TeX{} stackexchange community,
    including David Carlisle for \LaTeX{}.
