...
\begin{document}
  ...
  \begin{abstract}
    ...
    \FPround{\result}{\HallMinPID}{0} \result{}\%
  ...
  \section{Acknowledgements}
    ...
    Similarly, the support from the \TeX{} stackexchange community was
    invaluable for this project, specially David Carlisle who has solved
    our most hairy issues with \LaTeX{}.
