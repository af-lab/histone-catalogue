...
\input{results/variables-Marzluff-stats}
...
\begin{document}
  ...
  \section{Introduction}
    ...
    and H4\cite{Histonenomenc}. An additional histone H5 related to H1 is found in nucleus-containing avian
    ...
    ``lysine-rich'', whereas the remaining 4 histones with ratios \OthersArgLysRatio\ \think{should repeated proteins count twice?} are ``arginine-rich''.
    ...
    Table~\ref{tab:typical-histone-differences}. ``Variants'' play functionally distinctive roles, have lower aggregate abundance,
