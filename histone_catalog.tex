...
\begin{document}
  ...
  \begin{abstract}
    ...
    These variants have received little attention and no specialized function
    or expression profile is known about them, despite some of them displaying
    more variance than the ``real'' variants.
    ...
    the canonical H2A, H2B, H3, and H4 respectively.
...
%  \section{SNP's}
  ...
  \newpage
  \captionof{table}{Changes between the current status and the last published reference \citep{Marzluff02}.}
  ...
  \newpage
  \captionof{table}{Human variant histone genes, transcripts and protein}
