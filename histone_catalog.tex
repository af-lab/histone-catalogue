...
\begin{document}
  ...
  \section{Introduction}
    ...
    \subsection{Histone variation\think{call this section 'histone variants?' would be stronger and hints at the message we want to pass but may sound arrogant}}
      ...
      However, the variation level of the later is frequently underestimated, usually \think{or often?} ignored,
      and the main subject of this report.\think{can I call it paper or article?}

      For sake of brevity, we will refer to the core canonical histones as simply ``histones''.
...
%      of protein and gene sequence variation in canonical histones is often under-appreciated. Albig and 
      ...
      for each histone type.\think{even for the very different H2AZ and CENP--A?} However, PAGE with acetic acid in gels containing the non-ionic detergent
    ...
    \subsection{Current situation\think{this name sucks}}
      ...
      some oversights, most likeley due to the ``draft'' status of the genome it was based on (Table~\ref{tab:difference-from-Marzluff02}).
      ...
      is not yet complete, the histone gens containing some omissions and inconsistencies for the untranslated regions,
...
%    is based on their 3' UTR processing and genome positioning.
    ...
    \subsection{Gene clusters}
      ...
      are numbered by their size (Table~\ref{histone-gene-count}). The major and secondary histone gene clusters,
      HIST1 on chromosome 6, and the HIST2 on chromosome 1, contain contiguous high density arrays
      of histone genes, with \CodingGenesInHistOne{} and \CodingGenesInHistTwo{} functional\think{should count pseudogenes?}
      genes respectively.
      ...
      HIST1 encodes \CodingGenesInHistOne{} genes and \PseudoGenesInHistOne{} pseudogenes over a span of 2.3 megabasepairs and is the second
      most gene dense region on the megabase scale the genome \addref{Xie 2003}. It is located at the distal
      end of the major histocompatibility complex (MHC) in the extended class I region at chromosome
      6p21-22 \addref{MHC consortium Nature 1999}.

      HIST2 encodes \CodingGenesInHistTwo{} genes and \PseudoGenesInHistTwo{} pseudogenes over a span of 105 kilobasepairs.
