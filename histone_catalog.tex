...
\begin{document}
  ...
  \begin{abstract}
	Core histone proteins are encoded by a large family of genes distributed across the human genome.
	The canonical histones contribute the majority of proteins to bulk chromatin packaging, 
	and in total there are \TotalGenes{} canonical human core histone genes 
	including \HTwoACodingGenes{} for H2A,
	...
	of up to \todo{highest identity}\% in amino acid identity. 
	The gene sequence and protein isoform diversity 
	exceeds commonly used designations of variation such as H2A.1 and H3.1
	...
	To avoid the obsolescence and maintain readability of scientific literature, 
...
\beginsupplement
  ...
  \newpage
  \captionof{table}{Catalogue of human variant core histone genes 
  showing transcript, protein, and ID}
