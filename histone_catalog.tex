...
\begin{document}
  ...
  \begin{abstract}
	...
	In total there are \todo{total histone genes} canonical core histone genes, including \HTwoACodingGenes{} for H2A, \HTwoBCodingGenes{} for H2B,
	\HThreeCodingGenes{} for H3 and \HFourCodingGenes{} for H4, along with over \todo{total histone pseudogenes} total pseudogenes.
	...
	This represents a surprising and seldom recognised variation ranging 
	from \todo{lowest identity}\% amino acid identity in \todo{lowest identity histone type}
	to \todo{highest identity}\% amino acid identity in \todo{highest identity histone type}. 
	This diversity exists in parallel to the well-known divergence and specialisation of variant histones 
	and within commonly used designations such as H2A.1 and H3.1. 
	...
	This work and others has led to multiple corrections to human histone annotations, 
	...
	using genome annotations and inserts the information into this manuscript format. 
	We show that the approach can readily be adapted to histones of other organisms and to other gene families.
  \end{abstract}
