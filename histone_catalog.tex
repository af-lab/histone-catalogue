...
\begin{document}
  ...
  \section{Introduction}
    ...
    and H4. An additional histone H5 related to H1 is found in nucleus-containing avian
    erythrocytes and has been of research interest due to its elevated binding stability.
    Since the ratio of arginine/lysine is ?? for H1 and H5 these became known as
    "lysine-rich", whereas the remaining 4 histones with ratios ??-?? are "arginine-rich".
    ...
    table 1. "Variants" play functionally distinctive roles, have lower aggregate abundance,
    ...
    are polyadenylated on their 3' termini. \think{Are they transcribed by pol II?} Canonical
    ...
    classification of pseudo genes (supplementary table 1).
    ...
    in the submitted manuscript (\ref{sec:reproducible}) based on the most current data from the NCBI
    RefSeq database.
