...
\begin{document}
  ...
  \section{Introduction}
    ...
    ratios \CoreArgLysRatio{} are ``arginine-rich'' \todo{give ranges of values, by
    calculating this for each of the histone types}.
    ...
    displayed on \tref{tab:difference-from-Marzluff02} \todo{make this a supplementary table}.
