...
\begin{document}
  ...
  \section{Introduction}
    ...
    classification of pseudo genes (\tref{tab:difference-from-Marzluff02}).
    \todo{sounds like the changes on the table are only because of our changes. But we are only
          responsible for part of it, most of our fixes were on the untranslated regions. Fix this!}

    %% how can we mention the issue of having been refused certain changes?
    ...
    the tables and figures presented in the submitted manuscript (\Sref{sec:reproducible}) based
  ...
  \section{Histone genes}
    ...
    \subsection{Gene clusters}
      ...
      are numbered by their size (\tref{tab:histone-gene-count}).
      ...
      \subsubsection{Internal cluster organization}
        ...
        \todo[inline]{quote from ``Organization and expression of chicken histone genes'' section 2.1, by R. P. Harvey
                      and J. R. r. Wells: as a general thesis, we suggest that the evolutionary transition
                      of histone gene organization from an ordered to a disordered disposition is a function
                      of the declining frequency of recombinational events as the gene copy number becomes low,
                      and does not reflect a change in the mode of expression of histone genes.}
    ...
    \subsection{Gene nomenclature}
      ...
      3 parts (\fref{fig:nomenclature}): HIST1, H3, and B. The first two parts are self-explanatory,
      ...
      vice-versa (\tref{tab:difference-from-Marzluff02}).
