...
\begin{document}
  ...
  \section{Histone genes}
    ...
    \subsection{Histone gene clusters}
      ...
      %% FIXME: need to access "Human histone genes are interspersed with members of the Alu
      %%        family and with other transcribed sequences" (1982) by Sierra, others, and Stein
    ...
    \subsection{Histone gene nomenclature}
      %% explain the current nomenclature for genes and proteins as approved by the HGNC
