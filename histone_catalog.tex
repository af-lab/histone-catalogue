...
\begin{document}
  ...
  \begin{abstract}
    ...
    diverging to as low as
    \FPmin{result}{\HTwoAPID}{\HTwoBPID}%
    \FPmin{result}{\result}{\HThreePID}%
    \FPmin{result}{\result}{\HFourPID}%
    \result{}\% amino acid identity.
    \todo{this is not really right since it's the lowest overall PID between
          histones of the same type}
